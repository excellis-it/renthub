      ...
      <div class="row align-items-center m-0 gx-2">
        <div class="col-xxl-2 col-xl-3">
          <div class="filter_search">
                ...
                <input type="text" id="search" class="form-control" placeholder="Search for property rent"/>
      ...
      <div class="row m-0">
        <div class="col-lg-6 p-0">
          <div class="ifreame_map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d19780265.354188915!2d-95.89479048693913!3d43.97096007946946!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1715935127794!5m2!1sen!2sin" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
        </div>
        <div class="col-lg-6 p-0">
          ...
          <script>
              $(document).ready(function() {
                  $('#searchForm').on('submit', function(e) {
                      ...
                      $.ajax({
                          url: '/property-for-rent',  // The URL to which the request is sent
                          type: 'GET',
                          data: { search: searchValue },  // Send the search value as a query parameter
                          success: function(response) {
                              // Handle the response, e.g., update the page content with the search results
                              
                              // Update the URL in the address bar without the query string
                              history.replaceState(null, '', '/property-for-rent');
                          },
                          error: function(xhr) {
    ...
    <script>
        function openModal(getVal) {
          ...
          function search_data() {
              ...
              $.ajax({
                  url: "{{URL::to('/property-for-rent-search')}}",
                  type: 'GET',
                  dataType: 'text',
                  data: {
                      search: search,
