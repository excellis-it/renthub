        ...
        <div class="row align-items-center m-0 gx-2">
            <div class="col-xxl-2 col-xl-3">
                <div class="filter_search">
                    ...
                    <input type="text" id="search" class="form-control" placeholder="Search for vehicles..." />
                    ...
                    <div class="funel_box me-2">
                        <div class="btn-group">
                            <button type="button" class="btn btn_filter dropdown-toggle btn_all_open"
                                onclick="openModal('box1')">New / Used </button>
                            ...
                            <div class="box_slae openbox" id="box1">
                                ...
                                <a href="javascript:void(0);" class="filter_aplly" onclick="search_data()">Apply</a>
                            </div>
            ...
            <div class="col-lg-12 p-0">
                <div class="filter_view_room">
                    ...
                    <div class="row" id="vehicleList">
                        @include('frontend.vehicle-search')
                    </div>
                </div>
            </div>
        </div>
