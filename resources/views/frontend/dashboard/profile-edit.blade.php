                            ...
                            <form id="profile_update" action="{{ route('user-update') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row align-items-center mb-4">
                                    ...
                                    <div class="col-md-auto">
                                        <img src="{{ $user->photo ? asset('public/uploads/images/profile/'.$user->photo) : asset('frontend_assets/assets/images/admin-logo.jpg') }}" alt="Profile Image" class="rounded-circle" width="120" height="120" id="profile_image_preview">
                                    </div>
                                </div>
