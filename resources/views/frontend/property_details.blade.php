                                ...
                                <div class="room-details-div d-flex align-items-center">
                                    <div class="room-details d-flex align-items-center">
                                        <div class="room-d-img">
                                            <img src="{{ asset('frontend_assets/assets/images/bed.svg') }}" alt="">
                                        </div>
                                    ...
                                    <div class="room-details d-flex align-items-center">
                                        <div class="room-d-img">
                                            <img src="{{ asset('frontend_assets/assets/images/bath.svg') }}" alt="">
                                        </div>
                                        <div class="room-details-text">
                                    ...
                                    <div class="room-details d-flex align-items-center">
                                        <div class="room-d-img">
                                            <img src="{{ asset('frontend_assets/assets/images/sqft.svg') }}" alt="">
                                        </div>
                                        <div class="room-details-text">
