        ...
        <div class="featured_slider_machinery right_middle_arrow">
            ...
            <div class="feature_slid_padding">
                <div class="feature_box">
                    ...
                    <a href="javascript:void(0)" class="wishlist_rent"><i class="fa-solid fa-heart"></i></a>
                    <div class="feature_img">
                        <a href="{{ URL::to('equipment-and-machineries-details/' . Crypt::encrypt($val->product_id)) }}"><img src="{{ asset('public/images/' . $val->product_thumbnail) }}" /></a>
                    </div>
                    <div class="feature_text">
                        <div class="d-block d-md-flex justify-content-between">
                            <div class="commercial_propety">
                        ...
                        <div class="d-flex align-items-center pe-2"><span class="me-1"><img src="{{ asset('frontend_assets/assets/images/mfg_date.svg') }}" alt="" /></span> MFG Date:
        ...
        <div class="featured_slider_cars right_middle_arrow">
            ...
            <div class="feature_slid_padding">
                <div class="feature_box">
                    ...
                    <a href="javascript:void(0);" class="wishlist_rent"><i class="fa-solid fa-heart"></i></a>
                    <div class="feature_img">
                        <a href="{{ URL::to('vehicle-details/' . Crypt::encrypt($val->product_id)) }}"><img src="{{ asset('public/images/' . $val->product_thumbnail) }}" /></a>
                    </div>
                    <div class="feature_text">
                        <div class="d-block d-md-flex justify-content-between">
                            <div class="commercial_propety">
        ...
        <div class="featured_slider_truck right_middle_arrow">
            ...
            <div class="feature_slid_padding">
                <div class="feature_box">
                    ...
                    <a href="javascript:void(0)" class="wishlist_rent"><i class="fa-solid fa-heart"></i></a>
                    <div class="feature_img">
                        <a href="{{ URL::to('electronics-home-appliances-details/' . Crypt::encrypt($val->product_id)) }}"><img src="{{ asset('public/images/' . $val->product_thumbnail) }}" /></a>
                    </div>
                    <div class="feature_text">
                        <div class="d-block d-md-flex justify-content-between">
                            <div class="commercial_propety">
        ...
        <div class="back_bg_box">
            <div class="row justify-content-around">
                <div class="text-center col-xxl-3 col-md-4">
                    <span><img src="{{ file_exists(public_path('images/' . $home['section_7_image'])) ? asset('public/images/' . $home['section_7_image']) : asset('public/images/default-image.jpg') }}" alt="" />
                    </span>
                    <h4>{{$home['section_7_title'] ?? ''}}</h4>
                    <p>{!!$home['section_7_description'] ?? ''!!}</p>
                </div>
                <div class="text-center col-xxl-3 col-md-4">
                    <span><img src="{{ asset('public/images/'.$home['section_8_image']) }}" alt="" /></span>
                    <h4>{{$home['section_8_title'] ?? ''}}</h4>
                    <p>{!!$home['section_8_description'] ?? ''!!}</p>
                </div>
                <div class="text-center col-xxl-3 col-md-4">
                    <span><img src="{{ asset('public/images/'.$home['section_9_image']) }}" alt="" /></span>
