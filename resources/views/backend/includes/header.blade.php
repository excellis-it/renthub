            ...
            <div id="notification-button" class="top-menu ms-auto">
                <ul class="navbar-nav align-items-center">
                    <li class="nav-item dropdown dropdown-large">
                        ...
                        position-relative" href="#" <div class="top-menu ms-auto">
                            <ul class="navbar-nav align-items-center">
                                <li style="margin-bottom: 30px" class="nav-item dropdown dropdown-large">
                                    <a id="1" class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative"
            ...
            <div class="user-box dropdown">
                <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#"
                    ...
                    <img src="{{!empty($authData->photo) ?
                                url('public/uploads/images/profile/' . $authData->photo) :
                                url('public/uploads/images/user_default_image.png' )
                                 }}" class="user-img" alt="user
                    avatar">
                    <div class="user-info ps-3">
                        <p class="user-name mb-0">{{$authData->name}}</p>
                        <p class="designattion mb-0">@if($authData->role=='vendor'){{'Listing User'}} @else
                            {{$authData->role}} @endif</p>
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                        ...
                        <form action="{{URL::to('/logout')}}">
                            @csrf
                            <a href="{{URL::to('/logout')}}" class="dropdown-item" onclick="event.preventDefault();
