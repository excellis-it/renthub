        ...
        <form id="cms_form" action="{{url('admin/home/update')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="border p-4 rounded label_color">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <input name="section_7_image" id="image" class="form-control" type="file" value="{{ isset($home['section_7_image']) ? 'Current File: ' . $home['section_7_image'] : 'No file uploaded' }}">
                        ...
                        @if (!empty($home['section_7_image']))
                        <div class="col-md-12 mb-3">
                            <label for="inputEnterYourName" class="col-form-label">View
                                Image </label>
                            <br>
                            <img src="{{ asset('public/images/' . $home['section_7_image'] ?? '') }}" alt="" class="card-img-top" style="max-width: 100px; margin-top: 20px;background: orange;">
                        </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <input name="section_8_image" id="image" class="form-control" type="file" value="{{ isset($home['section_8_image']) ? 'Current File: ' . $home['section_8_image'] : 'No file uploaded' }}">
                        ...
                        @if (!empty($home['section_8_image']))
                        <div class="col-md-12 mb-3">
                            <label for="inputEnterYourName" class="col-form-label">View
                                Image </label>
                            <br>
                            <img src="{{ asset('public/images/' . $home['section_8_image'] ?? '') }}" alt="" class="card-img-top" style="max-width: 100px; margin-top: 20px;background: orange;">
                        </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9 text-secondary">
                        <input name="section_9_image" id="image" class="form-control" type="file" value="{{ isset($home['section_9_image']) ? 'Current File: ' . $home['section_9_image'] : 'No file uploaded' }}">
                        @if ($errors->has('section_9_image'))
                        <div class="error" style="color:red;">
                            {{ $errors->first('section_9_image') }}</div>
                        @endif

                        @if (!empty($home['section_9_image']))
                        <div class="col-md-12 mb-3">
                            <label for="inputEnterYourName" class="col-form-label">View
                                Image </label>
                            <br>
                            <img src="{{ asset('public/images/' . $home['section_9_image'] ?? '') }}" alt="" class="card-img-top" style="max-width: 100px; margin-top: 20px;background: orange;">
                        </div>
                        @endif
