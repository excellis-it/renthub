            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="{{route($role . '-profile')}}"><i class="bx
                        bx-home-alt"></i></a></li>
                    <li class="breadcrumb-item active" aria-current="page">Electronics Inquiry</li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="card">
    <div class="card-body">
        <div class="row justify-content-between align-items-center mb-2">
            <div class="col-md-6">
                <div>
                    <h4>User's Electronics Inquiry</h4>
                </div>
            </div>
            {{-- <div class="col-md-6">
        ...
        <div class="table-responsive">
            ...
            <table id="myTable" class="table table-striped table-bordered cusrsor-pointer">
                ...
                <tbody id="tableBodyContents">
                    @include('backend.inquiries.electronics_filter')
                </tbody>
            </table>
...
<script>
    ...
    function fetch_data(page, query = '') {
        $.ajax({
            url: "{{ route('admin-inquiries-vehicle-filter') }}?page=" + page + "&query=" + query,
