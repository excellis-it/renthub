            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="{{route($role . '-profile')}}"><i class="bx
                        bx-home-alt"></i></a></li>
                    <li class="breadcrumb-item active" aria-current="page">Property Inquiry</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="table-responsive">
            ...
            <table id="myTable" class="table table-striped table-bordered cusrsor-pointer">
                ...
                <tbody id="tableBodyContents">
                    @include('backend.inquiries.property_filter')
                </tbody>
            </table>
...
<script>
    ...
    function fetch_data(page, query = '') {
        $.ajax({
            url: "{{ route('admin-inquiries-property-filter') }}?page=" + page + "&query=" + query,
