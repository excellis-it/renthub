        ...
        <div class="table-responsive">
            ...
            <div class="ms-auto" style="margin-bottom: 20px">
                <a href="add_category" class="btn btn-primary radius-30 mt-2 mt-lg-0">
                    <i class="bx bxs-plus-square"></i>Add New Category</a>
            </div>
            @endif
                    ...
                    <tr>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <img src="{{url('public/uploads/images/category/' . $item->category_image)}}"
                        ...
                        <td>
                            <div class="d-flex order-actions">
                                ...
                                <div class="modal fade" id="exampleFullScreenModal-{{$item->category_id}}" tabindex="-1"
                                                        ...
                                                        <form class="category_form" action="{{route
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-9 text-secondary">
                                                                    ...
                                                                    <div>
                                                                        <img class="card-img-top" src="{{url('public/uploads/images/category/' .
                                                                                $item->category_image)}}"
                                ...
                                <a href="" class="ms-3" data-bs-toggle="modal"
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="exampleDangerModal-{{$item->category_id}}" tabindex="-1"
