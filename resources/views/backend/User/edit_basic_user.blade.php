...
@section('content')
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Basic User Detail</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="{{route($role . '-profile')}}"><i class="bx bx-home-alt"></i></a></li>
                    <li class="breadcrumb-item active" aria-current="page">Edit Basic User</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <h4 class="d-flex align-items-center mb-3">Edit Basic User</h4>
            <form id="subcription_form" action="{{route('admin-update-basic-user')}}" method="POST">
                @csrf
