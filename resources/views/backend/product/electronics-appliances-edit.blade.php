    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Electronics</li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="card">
    <div class="card-body p-4">
        <h5 class="card-title">Edit Electronics</h5>
        <hr />
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="border border-3 p-4 rounded">
                            ...
                            <!-- Short Description -->
                            <div class="mb-3">
                                <label for="inputProductShortDescription" class="form-label">Short Description<span style="color:red;">*</span></label>
                                ...
                                <span style="color: #e20000" class="error" id="product_short_description-error"></span>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="border border-3 p-4 rounded">
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <label for="inputMarkedPrice" class="form-label">Manufacture Date<span style="color:red;">*</span></label>
                                ...
                                <div class="col-12">
                                    <label for="inputBrand" class="form-label">Electronics Brand</label>
                                ...
                                <div class="col-12">
                                    <label for="inputSubCategory" class="form-label">Electronics Category</label>
                                ...
                                <div class="col-12">
                                    ...
                                    <select class="form-select" id="inputVendorType" name="vendor_type">
                                        ...
                                        <option value="manufacturer" {{ old('vendor_type', $item->vendor_type) ==
                                            'manufacturer' ? 'selected' : '' }}>Manufacturer</option>
                                ...
                                {{-- <div class="col-12">
                                    <input type="submit" name="submit" id="product_form" class="btn btn-primary"
                                        value="Save Product" />
                                </div> --}}
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('form').on('submit', function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{ url('vendor/electronics/update') }}",  // Laravel route URL
                    data: formData,
                    contentType: false,
                    processData: false,
