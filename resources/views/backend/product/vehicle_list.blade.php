...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="add-btn-1 d-flex justify-content-end">
            <a href="{{URL::to('vendor/vehicle/add')}}" class="btn">
                <i class="bx bxs-plus-square"></i>Add New Vehicle</a>
        </div>
        @endif
        </div>
    <!--end breadcrumb -->
            ...
            <div class="table-responsive">
                ...
                <table id="myTable" class="table table-striped table-bordered cusrsor-pointer">
                    ...
                    <tbody id="tableBodyContents">
                        @include('backend.product.vehicle_filter')
                    </tbody>
                </table>
    ...
    @section('js')
        ...
        <script>
            ...
            function fetch_data(page, query = '') {
                $.ajax({
                    url: "{{ route('vendor-vehicle.filter') }}?page=" + page + "&query=" + query,
