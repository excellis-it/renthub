...
<tr>
    ...
    <td>{{ $item->subcategory->sub_category_name ?? 'N/A' }}</td>
    ...
    <td>
        <div class="d-flex order-actions">
            ...
            <a href="{{ URL::to('vendor/property/edit/'.$item->product_id) }}"
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Are you sure you want to delete this property?</h5>

                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-light" data-bs-dismiss="modal">Cancel</button>
                            <button
                                onclick="window.location.replace('{{URL::to('vendor/property/remove/'.$item->product_id)}}');"
