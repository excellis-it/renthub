                        ...
                        <div class="border border-3 p-4 rounded">
                            ...
                            <div class="mb-3">
                                ...
                                <input name="tag_line" type="text" class="form-control" id="inputProductTitle"
                                    placeholder="Enter tag title" value="{{ old('tag_line', $item->tag_line) }}">
                            ...
                            <div class="mb-3">
                                <label for="inputProductTitle" class="form-label">Location<span
                                        style="color:red;">*</span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <input name="property_bed" type="number" class="form-control" id="inputProductTitle"
                                    placeholder="Enter property bed"
                                    value="{{ old('property_bed', $item->property_bed) }}">
                                <span style="color: #e20000" class="error" id="product_name-error"></span>
                            ...
                            <div class="mb-3">
                                ...
                                <input name="property_bathroom" type="number" min="0" class="form-control"
                                    ...
                                    value="{{ old('property_bathroom', $item->property_bathroom) }}">
                    ...
                    <div class="col-lg-4">
                        <div class="border border-3 p-4 rounded">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <label for="inputSubCategory" class="form-label">Property Category<span
                                            style="color:red;">*</span></label>
                                ...
                                <div class="col-12">
                                    ...
                                    <select class="form-select" id="inputVendorType" name="vendor_type">
                                        ...
                                        <option value="agent" {{ old('vendor_type', $item->vendor_type) == 'agent' ?
                                ...
                                <div class="col-12">
                                    ...
                                    <select class="form-select" id="inputProductType" name="product_type">
                                        <option value="">--Select--</option>
                                        <option value="rent" {{ old('product_type', $item->product_type) == 'rent' ?
                                            'selected' : '' }}>Used</option>
                                        <option value="sell" {{ old('product_type', $item->product_type) == 'sell' ?
                                            'selected' : '' }}>New</option>
                                    </select>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('form').on('submit', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ url('vendor/property/update') }}",  // Laravel route URL
                data: formData,
                contentType: false,
                processData: false,
