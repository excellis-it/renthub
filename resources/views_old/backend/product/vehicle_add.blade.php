...
@section('content')
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <hr/>
            <form action="{{url('vendor/vehicle/create')}}" method="POST"  enctype="multipart/form-data">
                    ...
                    <div class="row">
                            ...
                            <div class="border border-3 p-4 rounded">
                             <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="product_long_description"  id="product_long_description" class="form-control" rows="10"> </textarea>
                                    <small style="color: #e20000" class="error"
                        ...
                        <div class="col-lg-4">
                            <div class="border border-3 p-4 rounded">
                                <div class="row g-3">
                                 <div class="col-md-12">
                                        <label for="inputPrice" class="form-label">Vehicle Covered Distance</label>
                                        <input name="vehicle_km" type="text" class="form-control" id="inputPrice"
                                               placeholder="00.00">
                                        <small style="color: #e20000" class="error" id="vehicle_km-error"></small>
                                    </div>
                               <div class="col-md-12">
                                    ...
                                    <div class="col-12">
                                        <label for="inputProductType" class="form-label">Vehicle Brand</label>
                                    ...
                                    <div class="col-12">
                                        <label for="inputVendor" class="form-label">Vehicle Category</label>
                                    ...
                                    <div class="col-12">
                                        <label for="inputVendor" class="form-label">Vehicle For </label>
