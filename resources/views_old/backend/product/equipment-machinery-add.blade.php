...
@section('content')
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Add New Machinery</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body p-4">
            <h5 class="card-title">Add New Machinery</h5>
            <hr/>
                            ...
                            <div class="border border-3 p-4 rounded">
                             <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="product_short_description" class="form-control" id="product_short_description"
                                              height="10" ></textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="product_long_description" id="product_long_description" class="form-control" rows="3"> </textarea>
                                    <span style="color: #e20000" class="error"
...
@section('AjaxScript')
    ...
    <script type="text/javascript">
        ...
        $('form').on('submit', function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ url('vendor/machinery/create') }}",  // Laravel route URL
                data: formData,
                contentType: false,
                processData: false,
