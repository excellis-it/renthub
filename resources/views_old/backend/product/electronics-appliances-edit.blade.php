...
@section('content')
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <form action="{{url('vendor/electronics/update')}}" method="POST"  enctype="multipart/form-data">
            ...
            <div class="col-lg-4">
                <div class="border border-3 p-4 rounded">
                    <div class="row g-3">
                        ...
                        {{-- <div class="col-12">
                            <input type="submit" name="submit" id="product_form" class="btn btn-primary" value="Save Product" />
                        </div> --}}
                    </div>
                </div>
            </div>
