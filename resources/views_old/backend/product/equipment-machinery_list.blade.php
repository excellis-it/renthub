...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div class="add-btn-1 d-flex justify-content-end">
        <a href="{{URL::to('/vendor/machinery/add')}}" class="btn">
            <i class="bx bxs-plus-square"></i>Add New Machinery</a>
    </div>
    @endif
</div>
            ...
            <div class="table-responsive">
                ...
                <table id="myTable" class="table table-striped table-bordered cusrsor-pointer">
                    ...
                    <tr>
                        ...
                        <th>Machinery Price($)</th>
                        <th>Machinery Status</th>
                        <th>Actions</th>
                    </tr>
                    </thead>
                    <tbody id="tableBodyContents">
                        @include('backend.product.machinery_filter')
                    </tbody>
                </table>
    ...
    @section('js')
        ...
        <script>
             $(document).ready(function () {
                ...
                $.ajax({
                    url: "{{ route('vendor-machinery.filter') }}?page=" + page + "&query=" + query,
