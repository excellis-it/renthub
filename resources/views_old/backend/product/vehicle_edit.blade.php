...
@section('content')
    ...
    <div class="card">
        <div class="card-body p-4">
            ...
            <form action="{{url('vendor/vehicle/update')}}" method="POST"  enctype="multipart/form-data">
                ...
                <div class="form-body mt-4">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="product_long_description" class="form-control"  id="product_long_description" rows="3">{{ old('product_long_description', $item->product_long_description) }}</textarea>
            ...
            <div class="col-lg-4">
                <div class="border border-3 p-4 rounded">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            <label for="inputVehicleKm" class="form-label">Vehicle Covered Distance</label>
                        ...
                        <!-- Vehicle Category -->
                        <div class="col-12">
                            <label for="inputSubCategory" class="form-label">Vehicle Category</label>
                        ...
                        <div class="col-12">
                            ...
                            <select class="form-select" id="inputVendorType" name="vendor_type">
                                ...
                                <option value="owner" {{ old('vendor_type', $item->vendor_type) == 'owner' ? 'selected' : '' }}>Owner</option>
