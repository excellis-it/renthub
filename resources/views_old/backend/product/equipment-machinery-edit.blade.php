                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="border border-3 p-4 rounded">
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <label for="inputMarkedPrice" class="form-label">Manufacture Date<span
                                            style="color:red;">*</span></label>
                                ...
                                <div class="col-12">
                                    <label for="inputSubCategory" class="form-label">Machinery Category<span
                                            style="color:red;">*</span></label>
                                ...
                                {{-- <div class="col-12">
                                    <button name="submit" class="btn btn-primary" id="product_form">Save
                                        Product</button>
                                </div> --}}
                            </div>
                        </div>
