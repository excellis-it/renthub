            ...
            <div class="table-responsive">
                <div class="ms-auto" style="margin-bottom: 20px">
                    @if(Auth::user()->role == "vendor")
                        <a href="{{URL::to('/vendor/vehicle/add')}}" class="btn btn-primary radius-30 mt-2 mt-lg-0">
                            <i class="bx bxs-plus-square"></i>Add New Vehicle</a></div>
                @endif
                            ...
                            <td>
                               <div class="d-flex order-actions">
                                    @if(Auth::user()->role == "vendor")
                                        ...
                                        <a href="{{URL::to('vendor/vehicle/edit/'.$item->product_id)}}" data-bs-target="#editProductModal-{{ $item->product_id }}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content bg-danger">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button
                                                                onclick="window.location.replace('{{URL::to('vendor/vehicle/remove/'.$item->product_id)}}');"
