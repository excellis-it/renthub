    ...
    <section class="feature_sec gift_busket bg_services_bg">
        <div class="container">
            <div class="row justify-content-between align-items-center">
                <div class="col-md-8">
                    <div class="mb-4 heading_hp">
                        <h2>Featured in Equipments & Machinery</h2>
                    </div>
                </div>
                <div class="col-md-4 text-end">
                    <div>
            ...
            <div class="back_bg_box">
                <div class="row justify-content-around">
                    <div class="text-center col-xxl-3 col-md-4">
                        <span><img src="{{ asset('frontend_assets/assets/images/fast.svg') }}" alt="" /></span>
                        <h4>Fast Service</h4>
                        <p>Passage Of Lorem Ipsum, You Need To Be Amet Embarrassing.</p>
                    </div>
                    <div class="text-center col-xxl-3 col-md-4">
                        <span><img src="{{ asset('frontend_assets/assets/images/support.svg') }}"
                                alt="" /></span>
                        <h4>Customer Support</h4>
                        <p>Passage Of Lorem Ipsum, You Need To Be Amet Embarrassing.</p>
                    </div>
                    <div class="text-center col-xxl-3 col-md-4">
                        <span><img src="{{ asset('frontend_assets/assets/images/safe.svg') }}" alt="" /></span>
                        <h4>Safe & Secure Listings</h4>
                        <p>Passage Of Lorem Ipsum, You Need To Be Amet Embarrassing.</p>
                    </div>
                </div>
            </div>
