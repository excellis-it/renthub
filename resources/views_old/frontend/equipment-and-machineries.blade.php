...
@include('frontend.includes.header')
      ...
      <div class="row align-items-center m-0 gx-2">
        <div class="col-xxl-2 col-xl-3">
          <div class="filter_search">
                ...
                <input type="text" id="search" class="form-control" placeholder="Search for machines..."/>
        ...
        <div class="col-lg-12 p-0">
          <div class="filter_view_room">
            ...
            <div class="row" id="machineList">
                @include('frontend.equipment-and-machineries-search')
    ...
    <script>
        ...
        function search_data() {
            ...
            $.ajax({
                url: "{{URL::to('/equipment-and-machineries-search')}}",
                type: 'GET',
                dataType: 'text',
                data: {
                    search: search,
