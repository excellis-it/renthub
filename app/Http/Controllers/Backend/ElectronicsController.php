...
class ElectronicsController extends Controller
{
    ...
    public function listFilter(Request $request)
    {
        if ($request->ajax()) {
            ...
            $data = ProductModel::where('category_id', 3)
    ...
    public function add()
    {
        ...
        $subCategories = SubCategoryModel::where('category_id', 3)->orderBy('sub_category_id', 'desc')->get();
        return view('backend.product.electronics-appliances-add', compact('brands', 'subCategories'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return response()->json(['status' => true, 'message' => 'Electronics Added successfully']);
    }
    ...
    public function edit(Request $request)
    {
        ...
        $brands = BrandModel::orderBy('brand_id', 'desc')->get();
        $subCategories = SubCategoryModel::where('category_id', 3)->orderBy('sub_category_id', 'desc')->get();
        return view('backend.product.electronics-appliances-edit', compact('brands', 'subCategories', 'item','images'));
    }
    public function update(Request $request)
    {
        ...
        // echo $request->tag_line;die;
        return response()->json(['status' => true, 'message' => 'Electronics Updated successfully']);
    }
    public function delete(Request $request)
    {
        ...
        toastr()->error('Electronics Deleted successfully', ['timeout' => 3000]);
